...
class TestSenderConnect(unittest.TestCase):
    ...
    def test_syn_acked(self):
        ...
        test.fill()
        self.assertIsNone(test.optional_sender_message())
...
class TestSenderRetx(unittest.TestCase):
    ...
    def test_retx_syn_until_too_many_retransmissions(self):
        ...
        for retx in range(MAX_RETX_ATTEMPTS):
            ...
            self.assertLessEqual(test.consecutive_retransmissions(),
                                 MAX_RETX_ATTEMPTS)
            self.assertIsNone(test.optional_sender_message())
            test.tick(1)
            self.assertLessEqual(test.consecutive_retransmissions(),
        ...
        self.assertLessEqual(test.consecutive_retransmissions(),
                             MAX_RETX_ATTEMPTS)
        test.tick(1)
        self.assertGreater(test.consecutive_retransmissions(),
                           MAX_RETX_ATTEMPTS)
